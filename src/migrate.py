...
def migrate():
    ...
    migrate_input = input("Do you want to migrate songs to new directory structure? ([y]es/(n)o): ")
    if ORGANIZE_SONGS and ((migrate_input == "y") or (migrate_input == "")):
        ...
        print("💀 Set ORGANIZE_SONGS variable in .env file to true")
        exit()
